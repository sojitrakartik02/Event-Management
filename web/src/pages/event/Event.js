...
const Event = () => {
  ...
  const { events, getevent, editevent, getcategory, getsponser, deletevent } =
    context;
  ...
  const updateEvent = (currentEvent) => {
    ...
    setEvent({
      id: currentEvent._id,
      ename: currentEvent.eventName,
      edetail: currentEvent.eventDescription,
      elocation: currentEvent.eventLocation,
      estdate: currentEvent.eventStDate,
      eendate: currentEvent.eventEndDate,
      econtact: currentEvent.contact,
      eimage: currentEvent.image,
      enoticket: currentEvent.noOfTicket,
      eprice: currentEvent.totalPrice,
      ecategory: currentEvent.category,
      esponser: currentEvent.sponser,
    });
  };
  const handleClick = () => {
    ...
    const regex = /^\S*$/;
    if (
      !regex.test(event.ename) ||
      !regex.test(event.edetail) ||
      !regex.test(event.elocation) ||
      !regex.test(event.econtact)
    ) {
    ...
    <>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              Once a event is deleted, it cannot be recovered. Do you want to
              delete a event?
            </div>
            <div class="modal-footer">
              ...
              <button onClick={delevent} type="button" class="btn btn-primary">
                delete event
              </button>
            </div>
          </div>
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                <label for="ename" className="form-label text-dark">
                  Event Title
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label for="edetail" className="form-label text-dark">
                  Event Details
                </label>
                <textarea
                  className="form-control"
              ...
              <div className="mb-3">
                <label for="eimg" className="form-label text-dark">
                  Add image
                </label>
                <input
                  className="form-control"
              ...
              <div className="mb-3">
                <label for="estdate" className="form-label text-dark">
                  Start Date
                </label>
                <input
                  type="date"
              ...
              <div className="mb-3">
                <label for="endate" className="form-label text-dark">
                  End Date
                </label>
                <input
                  type="date"
              ...
              <div className="mb-3">
                <label for="elocation" className="form-label text-dark">
                  Venu / Address
                </label>
                <textarea
                  className="form-control"
                  ...
                  onChange={onchange}
                  rows="3"
                  value={event.elocation}
                ></textarea>
              </div>
              <div className="mb-3">
                <label for="ecategory" className="form-label text-dark">
                  Event Category
                </label>
                <select
              ...
              {/* TODO  */}
              <div className="mb-3">
                <label for="esponser" className="form-label text-dark">
                  Event Sponser
                </label>
                <select
                  className="form-select form-select-sm"
                  ...
                  aria-label="Small select example"
                  name="esponser"
                  value={event.esponser}
                >
                  <option selected>Open this select menu</option>
                  {spn &&
                    spn.map((sponser) => {
                      return (
                        <option value={sponser._id}>
                          {sponser.sponserName}
                        </option>
                      );
                    })}
              ...
              <div className="mb-3">
                <label for="enoticket" className="form-label text-dark">
                  Total seat
                </label>
                <input
                  type="tel"
                  ...
                  onChange={onchange}
                  placeholder=""
                  value={event.enoticket}
                />
              </div>
              <div className="mb-3">
                <label for="eprice" className="form-label text-dark">
                  Ticket Price
                </label>
                <input
                  type="tel"
              ...
              <div className="mb-3">
                <label for="econtact" className="form-label text-dark">
                  Phone Number
                </label>
                <input
                  type="tel"
      ...
      <div className="page__full-wrapper">
        <Navbar
          ...
          arrow={arrow}
          arrowE={arrowE}
          handleArrowEClick={handleArrowEClick}
        />
                ...
                <div className="tab-content" id="myTabContent">
                  ...
                  >
                    <div className="body__card-wrapper">
                      <h4 className="event__information-title mb-2">
                        Event List
                      </h4>
                          ...
                          <TableContainer>
                            <Table>
                              ...
                              <TableBody>
                                {row.length === 0 ? (
                                  <TableCell>
                                    No event availabel please add event
                                  </TableCell>
                                ) : (
                                  row &&
                                  row
