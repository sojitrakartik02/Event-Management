              ...
              <div class="tabs-pill">
                ...
                >
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      class="nav-link"
                      id="pills-purchased-tab"
                      data-bs-toggle="pill"
                      data-bs-target="#pills-purchased"
                      type="button"
                      role="tab"
                      aria-controls="pills-purchased"
                      aria-selected="true"
                    >
                      {" "}
                      <i class="bi bi-bag"></i> <span>Purchased</span>
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      <div className="row ">
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 mb-3">
                          <div className="img d-flex justify-content-center align-items-center">
                            <img
                              src="https://demo.egenslab.com/html/eventlab/assets/images/event/event-orgainizer.png"
                              alt="img"
                              className="img-fluid h-75 rounded w-75"
                            />
                          </div>
                        </div>
