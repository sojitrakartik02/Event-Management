              ...
              <div className="ed-main-wrap">
                <div className="ed-top">
                  <div className="ed-thumb">
                    <img
                      src="https://demo.egenslab.com/html/eventlab/assets/images/event/ed-thumb.png"
                      alt="img"
                    />
                  </div>
                  <ul className="ed-status">
                    <li>
                      <i className="bi bi-calendar2-week"></i> January 21, 2021
                    </li>
                    <li className="active">
                      <i className="bi bi-diagram-3"></i> <span>500</span> Seat
                    </li>
                    <li>
                      <i class="bi bi-geo"></i> Ahmedabad, India
                    </li>
                  </ul>
                    ...
                    >
                      <div className="details-tab-content">
                        ...
                        <p>
                          ...
                          Donec mattis posuere pharetra. Donec vestibulum ornare
                          velit ut sollicitudin. Pellentesque in faucibus
                          purus.Nulla nisl tellus, hendrerit nec dignissim
                          pellentesque, posuere in est. Suspendisse bibendum
                          vestibulum elit eu placerat. In ut ipsum in odio
                          euismod tincidunt non lacinia nunc. Donec ligula
                          augue, mattis eu varius ac.
                        </p>
                        <div className="row ed-overview">
                          <div className="col-lg-6">
                            ...
                            <ul className="overview-list">
                              <li>
                                <i className="bi bi-check2"></i> You Got Full
                                Free Certificate.
                              </li>
                              <li>
                                <i className="bi bi-check2"></i> Unlimited Coffe
                                & Tea When U Boring.
                              </li>
                              <li>
                                <i className="bi bi-check2"></i> Etiam dictum,
                                dui sit amet venenatis.
                              </li>
                              <li>
                                <i className="bi bi-check2"></i> Class aptent
                                taciti sociosqu ad litora.
                              </li>
                              <li>
                                <i className="bi bi-check2"></i> Lunch
                                Suspendisse in commodo feli.
                              </li>
                            </ul>
                          </div>
                          <div className="col-lg-6">
                            <div className="overview-images d-grid">
                              <div className="overview-img1">
                                <img
                                  src="https://demo.egenslab.com/html/eventlab/assets/images/gallary/view1.png"
                                  alt="img"
                                  className="img-fluid"
                                />
                              </div>
                              <div className="overview-img2">
                                <img
                                  src="https://demo.egenslab.com/html/eventlab/assets/images/gallary/view2.png"
                                  alt="img"
                                  className="img-fluid"
                                />
                              </div>
                    ...
                    <li className="event-card-sm">
                      <div className="event-thumb">
                        <a href="event-details.html">
                          <img
                            src="https://demo.egenslab.com/html/eventlab/assets/images/event/event-thumb-sm1.png"
                            alt="img"
                          />
                        </a>
                      </div>
                      <div className="event-sm-info">
                        <h5>
                          <a href="event-details.html">
                            Donec risus dui, suscipit iand tempor lacinia
                            vehicula.
                          </a>
                        </h5>
                        <div className="event-bottom">
                          <a className="event-date" href=".">
                            <i className="bi bi-calendar2-week"></i> January 21,
                            2021
                          </a>
                          <div className="event-deat">
                            <i className="bi bi-diagram-3"></i> <span>500</span>
                          </div>
                        </div>
